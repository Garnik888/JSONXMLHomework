...
public class EmployeeJsonConverter {
    ...
    public static void main(String[] args) {
        ...
        employeeList.add(new Employee("name", "lastname", 18,null, null));
        employeeList.add(new Employee("name2", "lastname2", 20,null,null));
        employeeList.add(new Employee("name3", "lastname3", 30,null,null));
